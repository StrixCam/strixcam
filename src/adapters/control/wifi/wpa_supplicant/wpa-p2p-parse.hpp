...
inline auto ParseQuotedField(std::string_view text,  // NOLINT(bugprone-easily-swappable-parameters) // floor-ok: fixed (haystack, key) convention consumed positionally by external callers
